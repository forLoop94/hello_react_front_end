...
2. Clone this repo
```
git clone https://github.com/forLoop94/hello_rails_front_end.git
```
...
Feel free to check the [issues page](https://github.com/forLoop94/hello_react_front_end/issues).
